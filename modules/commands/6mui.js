...
"https://i.imgur.com/EsyfaJp.jpg",
     ...
     var callback = () => api.sendMessage({body:`Bớt Ghiền Lại Nha -.-`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
